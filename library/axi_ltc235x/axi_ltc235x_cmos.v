...
module axi_ltc235x_cmos #(
	...
	parameter ACTIVE_LANE = 8'b1111_1111, // TODO: make this an input signal
  ...
  */
  ...
  generate
    for (i=0; i < 8; i=i+1) begin: format
      assign adc_data_s[i] = (adc_softspan[i] == 3'b0)? 32'h0 : (adc_softspan[i][1])? {{14{adc_data_store[i][23]}}, adc_data_store[i][23:6]} : {{14{0}}, adc_data_store[i][23:6]};
