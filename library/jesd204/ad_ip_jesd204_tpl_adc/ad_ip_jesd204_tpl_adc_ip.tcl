...
adi_ip_create ad_ip_jesd204_tpl_adc
 ...
 create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name my_ila
    ...
    set_property -dict [list CONFIG.C_PROBE0_WIDTH {64}] [get_ips my_ila]
    set_property -dict [list CONFIG.C_PROBE1_WIDTH {64}] [get_ips my_ila]
    ...
    generate_target {all} [get_files ad_ip_jesd204_tpl_adc.srcs/sources_1/ip/my_ila/my_ila.xci]
