...
module axi_ad7606b #(
  ...
  assign rd_req_pif = adc_rd_req[0] | adc_rd_req[1] | adc_rd_req[2] | adc_rd_req[3] | adc_rd_req[4] | adc_rd_req[5] | adc_rd_req[6] | adc_rd_req[7];
  ...
  axi_ad7606b_pif i_ad7606_parallel_interface (
    .cs_n (rx_cs_n),
    .db_o (rx_db_o),
    .db_i (rx_db_i),
    .db_t (rx_db_t),
